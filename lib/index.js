...
class MCReactModule {
    ...
    /**
     * Enables geofences in the native Marketing Cloud SDK.
     */
    static enableGeofences() {
        RNMarketingCloudSdk.enableGeofences();
    }

    /**
     * Disables geofences in the native Marketing Cloud SDK.
     */
    static disableGeofences() {
        RNMarketingCloudSdk.disableGeofences();
    }

    /**
     * Get all *active* Inbox messages already downloaded from the Marketing Cloud SDK.
     */
    ...
    /**
     * Refresh messages in the SDK
     */
    static refreshInbox() {
        return RNMarketingCloudSdk.refreshInbox();
    }

    /**
     * Get count of all *active* Inbox messages already downloaded from the Marketing Cloud SDK.
     */
    ...
    /**
     * Get count of all *unread* Inbox messages already downloaded from the Marketing Cloud SDK.
     */
     ...
     */
    static markMessageWithIdRead(id) {
        return RNMarketingCloudSdk.markMessageWithIdRead(id);
    }

    /**
     * Mark a Inbox message as deleted.
     */
    static markMessageWithIdDeleted(id) {
        return RNMarketingCloudSdk.markMessageWithIdDeleted(id);
    }
}
